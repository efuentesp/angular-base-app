...
export class ParentescoService {
    ...
    getAllParentesco(){
      return this.http.get(this.env.api + "/parentesco").pipe(map(res => res.json()));
    }
    ...
    saveParentesco(parentesco){
		...
		if (!parentesco.parentescoId){
            return this.http.post(this.env.api + "/parentesco", parentesco).pipe(map(res => res));
        }else{
            return this.http.put(this.env.api + "/parentesco/"+parentesco.parentescoId, parentesco).pipe(map(res => res));
        }
